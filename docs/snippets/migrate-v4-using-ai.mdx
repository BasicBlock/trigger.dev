...
We've deprecated the `@basicblock/trigger-sdk/v3` import path and moved to a new path:
...
import { task, locals, tasks } from "@basicblock/trigger-sdk";
...
import { toolTask, schemaTask } from "@basicblock/trigger-sdk";
import { z } from "zod";
...
import { schemaTask, ai } from "@basicblock/trigger-sdk";
import { z } from "zod";
import { generateText } from "ai";
...
import { queue, task } from "@basicblock/trigger-sdk";
