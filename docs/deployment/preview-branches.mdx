...
```ts
import { configure } from "@basicblock/trigger-sdk";
...
// You will need to install the @basicblock/trigger-build package
...
import { defineConfig } from "@basicblock/trigger-sdk";
// You will need to install the @basicblock/trigger-build package
import { syncVercelEnvVars } from "@basicblock/trigger-build/extensions/core";
