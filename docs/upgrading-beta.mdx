...
To use the new build system, you have to update to use our latest packages. Update the `@basicblock/trigger-sdk` package in your package.json:

```json
"@basicblock/trigger-sdk": "^3.0.0",
```
...
```sh
npm add @basicblock/trigger-build@latest -D
```
