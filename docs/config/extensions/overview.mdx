...
You can use pre-built extensions by installing the `@basicblock/trigger-build` package into your `devDependencies`, or you can create your own.
...
If you are using a pre-built extension, you can import it from the `@basicblock/trigger-build` package:
