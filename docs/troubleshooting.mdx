...
```
Could not resolve "@basicblock/trigger-core"
The Yarn Plug'n'Play manifest forbids importing "@basicblock/trigger-core" here because it's not listed as a dependency of this package
```
...
```ts
import { heartbeats } from "@basicblock/trigger-sdk";
