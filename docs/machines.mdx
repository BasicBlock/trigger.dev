...
import type { TriggerConfig } from "@basicblock/trigger-sdk";
...
import { task, logger, wait } from "@basicblock/trigger-sdk";
...
```ts /trigger/heavy-task.ts
import { task } from "@basicblock/trigger-sdk";
import { OutOfMemoryError } from "@basicblock/trigger-sdk";
