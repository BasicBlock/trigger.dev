...
```bash npm
npm add @basicblock/trigger-sdk@latest
npm add --save-dev @basicblock/trigger-build@latest
```

```bash pnpm
pnpm add @basicblock/trigger-sdk@latest
pnpm add -D @basicblock/trigger-build@latest
```

```bash yarn
yarn add @basicblock/trigger-sdk@latest
yarn add -D @basicblock/trigger-build@latest
```

```bash bun
bun add @basicblock/trigger-sdk@latest
bun add -D @basicblock/trigger-build@latest
```
...
```bash
# npm
npm install @basicblock/trigger-react-hooks@latest

# pnpm
pnpm add @basicblock/trigger-react-hooks@latest

# yarn
yarn add @basicblock/trigger-react-hooks@latest

# bun
bun add @basicblock/trigger-react-hooks@latest
```
...
Build extensions allow you to customize the build process. Ensure you have the `@basicblock/trigger-build` package installed in your project (see [package installation](#package-installation)).
...
```typescript
export * from "@basicblock/trigger-sdk"; // Export values and types from the Trigger.dev sdk
```
