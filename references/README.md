...
```json
{
  ...
  "compilerOptions": {
    ...
    "paths": {
      "@/*": ["./src/*"],
      "@basicblock/trigger-sdk": ["../../packages/trigger-sdk/src/index"],
      "@basicblock/trigger-sdk/*": ["../../packages/trigger-sdk/src/*"],
      "@trigger.dev/express": ["../../packages/express/src/index"],
      "@trigger.dev/express/*": ["../../packages/express/src/*"],
      "@basicblock/trigger-core": ["../../packages/core/src/index"],
      "@basicblock/trigger-core/*": ["../../packages/core/src/*"],
