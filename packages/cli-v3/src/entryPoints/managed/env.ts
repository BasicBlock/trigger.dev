...
const Env = z.object({
  ...
  TRIGGER_IPC_RESTORE_ALIVE_TIMEOUT_MS: z.string().optional(),
  TRIGGER_IPC_DIRECTIONAL_PROBE_DURATION_MS: z.string().optional(),
  TRIGGER_IPC_DIRECTIONAL_PROBE_INTERVAL_MS: z.string().optional(),
  TRIGGER_IPC_DIRECTIONAL_PING_TIMEOUT_MS: z.string().optional(),
  TRIGGER_IPC_POST_RESTORE_RESET_ATTEMPTS: z.string().optional(),
  TRIGGER_IPC_POST_RESTORE_RESET_TIMEOUT_MS: z.string().optional(),
  TRIGGER_IPC_POST_RESTORE_RESET_RETRY_DELAY_MS: z.string().optional(),
  TRIGGER_IPC_TRANSPORT: z.string().optional(),
  TRIGGER_IPC_SOCKET_CONNECT_TIMEOUT_MS: z.string().optional(),
  TRIGGER_IPC_RESTORE_RECONNECT_TIMEOUT_MS: z.string().optional(),
});
...
export class RunnerEnv {
  ...
  get TRIGGER_IPC_RESTORE_ALIVE_TIMEOUT_MS() {
    return this.env.TRIGGER_IPC_RESTORE_ALIVE_TIMEOUT_MS;
  }
  get TRIGGER_IPC_DIRECTIONAL_PROBE_DURATION_MS() {
    return this.env.TRIGGER_IPC_DIRECTIONAL_PROBE_DURATION_MS;
  }
  get TRIGGER_IPC_DIRECTIONAL_PROBE_INTERVAL_MS() {
    return this.env.TRIGGER_IPC_DIRECTIONAL_PROBE_INTERVAL_MS;
  }
  get TRIGGER_IPC_DIRECTIONAL_PING_TIMEOUT_MS() {
    return this.env.TRIGGER_IPC_DIRECTIONAL_PING_TIMEOUT_MS;
  }
  get TRIGGER_IPC_POST_RESTORE_RESET_ATTEMPTS() {
    return this.env.TRIGGER_IPC_POST_RESTORE_RESET_ATTEMPTS;
  }
  get TRIGGER_IPC_POST_RESTORE_RESET_TIMEOUT_MS() {
    return this.env.TRIGGER_IPC_POST_RESTORE_RESET_TIMEOUT_MS;
  }
  get TRIGGER_IPC_POST_RESTORE_RESET_RETRY_DELAY_MS() {
    return this.env.TRIGGER_IPC_POST_RESTORE_RESET_RETRY_DELAY_MS;
  }
  get TRIGGER_IPC_TRANSPORT() {
    return this.env.TRIGGER_IPC_TRANSPORT;
  }
  get TRIGGER_IPC_SOCKET_CONNECT_TIMEOUT_MS() {
    return this.env.TRIGGER_IPC_SOCKET_CONNECT_TIMEOUT_MS;
  }
  get TRIGGER_IPC_RESTORE_RECONNECT_TIMEOUT_MS() {
    return this.env.TRIGGER_IPC_RESTORE_RECONNECT_TIMEOUT_MS;
  }
  ...
  gatherProcessEnv(): Record<string, string> {
    const $env = {
      ...
      TRIGGER_IPC_TRANSPORT: this.TRIGGER_IPC_TRANSPORT,
      TRIGGER_IPC_SOCKET_CONNECT_TIMEOUT_MS: this.TRIGGER_IPC_SOCKET_CONNECT_TIMEOUT_MS,
      TRIGGER_IPC_RESTORE_RECONNECT_TIMEOUT_MS: this.TRIGGER_IPC_RESTORE_RECONNECT_TIMEOUT_MS,
    };
